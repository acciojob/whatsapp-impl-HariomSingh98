...
public class WhatsappRepository {
    ...
    private HashMap<Group, List<User>> groupUserMap;//info about group and members of it
    private HashMap<Group, List<Message>> groupMessageMap;//info about group with the message
    private HashMap<Message, User> senderMap;//info about message and its sender
    private HashMap<Group, User> adminMap;//info about group and its admin
    private HashSet<String> userMobile;//store all the mobile number  in  the  whatsapp

    private int customGroupCount;//no of group
    ...
    public Group createGroup(List<User> users) {
        ...
        if(users.size()==2){              // personal chat
            ...
            this.customGroupCount++;//increase group count
